...
public class KategoriDokumenService {
    ...
    public KategoriDokumen simpan(String namaKategori, String deskripsi, TipeKategori tipe) {
        ...
        KategoriDokumen kategori = KategoriDokumen.builder()
            ...
            .deskripsi(deskripsi)
            .tipe(tipe != null ? tipe : TipeKategori.INDIVIDU)
            .build();
        return kategoriRepository.save(kategori);
    }

    public KategoriDokumen update(Long id, String namaKategori, String deskripsi, TipeKategori tipe) {
        KategoriDokumen kategori = findById(id);
        kategori.setNamaKategori(namaKategori);
        kategori.setDeskripsi(deskripsi);
        if (tipe != null) {
            kategori.setTipe(tipe);
        }
        return kategoriRepository.save(kategori);
    }
    ...
    public List<KategoriDokumen> findByTipe(TipeKategori tipe) {
        return kategoriRepository.findByTipe(tipe);
    }
}
