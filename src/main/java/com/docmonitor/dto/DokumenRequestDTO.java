...
public class DokumenRequestDTO {
    ...
    // Daftar email peserta untuk dokumen bersama
    private java.util.List<String> emailPeserta = new java.util.ArrayList<>();
    ...
    public java.util.List<String> getEmailPeserta() { return emailPeserta; }
    public void setEmailPeserta(java.util.List<String> emailPeserta) { this.emailPeserta = emailPeserta; }
}