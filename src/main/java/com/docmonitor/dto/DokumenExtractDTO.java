...
public class DokumenExtractDTO {
    ...
    public DokumenExtractDTO(String extractedText, String namaDokumen, String kategori, String tanggalBerakhir, String confidence) {
    ...
    public void setTanggalBerakhir(String tanggalBerakhir) { this.tanggalBerakhir = tanggalBerakhir; }
    ...
    public static class DokumenExtractDTOBuilder {
        ...
        public DokumenExtractDTOBuilder tanggalBerakhir(String tanggalBerakhir) {
            this.tanggalBerakhir = tanggalBerakhir;
            return this;
        }
